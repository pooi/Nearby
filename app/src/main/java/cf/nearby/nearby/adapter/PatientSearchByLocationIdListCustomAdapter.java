 ...
 */
public class PatientSearchByLocationIdListCustomAdapter extends RecyclerView.Adapter<PatientSearchByLocationIdListCustomAdapter.ViewHolder> {

    // UI
    private Context context;
    private SearchPatientByLocationIdActivity activity;
    ...
    // 생성자
    public PatientSearchByLocationIdListCustomAdapter(Context context, ArrayList<Patient> list, RecyclerView recyclerView, OnAdapterSupport listener, SearchPatientByLocationIdActivity activity) {
        this.context = context;
        this.list = list;
        this.onAdapterSupport = listener;
        this.activity = (SearchPatientByLocationIdActivity)activity;
