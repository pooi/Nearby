...
import cf.nearby.nearby.adapter.PatientSearchByLocationIdListCustomAdapter;
...
public class SearchPatientByLocationIdActivity extends BaseActivity implements OnAdapterSupport {
    ...
    private PatientSearchByLocationIdListCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_patient_by_location_id);
    ...
    public void makeList(){
        ...
        adapter = new PatientSearchByLocationIdListCustomAdapter(getApplicationContext(), list, rv, this, this);
    ...
    public void redirectNextActivity(Patient patient){
        switch (nextActivity){
            ...
            case Information.NURSE_RECORD_MENU:{
                Intent intent = new Intent(SearchPatientByLocationIdActivity.this, NurseRecordActivity.class);
                intent.putExtra("patient", patient);
                startActivity(intent);
                break;
            }
